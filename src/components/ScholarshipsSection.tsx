...
export default function ScholarshipsSection() {
  ...
  const scholarshipData = {
    merit: {
      ...
      points: [
        "Waiver applies to the academic tuition fee.",
    ...
    sunet: {
      ...
      highlightValue: "Up to 50% Waiver",
      highlightLabel: "On First-Year Tuition",
      highlightBg: "from-amber-50 to-amber-100/30 border-amber-100 text-amber-850",
      table: {
        headers: ["SUNET Score Range", "Tuition Fee Waiver"],
        rows: [
          ["75% – 84%", "20% Waiver"],
          ["85% – 94%", "30% Waiver"],
    ...
    sports: {
      ...
      table: {
        headers: ["Level of Achievement", "Tuition Fee Waiver"],
        rows: [
          ["State Level", "20% Waiver"],
          ["National Level", "30% Waiver"],
